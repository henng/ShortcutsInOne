...
public class SmallFloatWindow extends LinearLayout {
	...
	public SmallFloatWindow( Context context ) {
		...
		LayoutInflater.from(context).inflate(R.layout.small_floatwindow, this);
		
		View view  = findViewById(R.id.small_window_layout);
		viewWidth  = view.getLayoutParams().width;
		viewHeight = view.getLayoutParams().height;
		TextView percentView = (TextView) findViewById(R.id.memory);
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		switch (event.getAction()) {
			...
			case MotionEvent.ACTION_UP:
				...
				// 原理是对的，但是相等条件过于严格，实际操作中很难达到这样的点击事件，应该是在一定范围内都判定为 点击事件
